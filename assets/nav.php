...
<nav class="navbar navbar-expand-lg  p-2 fixed-top  bg-light">
  <div class="container">
    ...
    <?php if ($_SESSION['in_club'] == 0) : ?>
      <a href="#" class="navbar-brand text-primary logo" style="font-size: 15px ;"><img src="../images/nstu.png" alt="user icon" style="width:25px;border-radius:50%;" /> CLUB CONNECT</a>
