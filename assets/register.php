...
include 'config.php';
  ...
  function sendMail($email,$v_code){
      ...
      try {
        ...
        $mail->Username   = 'labonicsejnu@gmail.com';                     //SMTP username
        $mail->Password   = 'vzpoapxdrzpobqwv';                               //SMTP password
        ...
        //Recipients
        $mail->setFrom('labonicsejnu@gmail.com', 'CLUB CONNECT');
        $mail->addAddress($email);     //Add a recipient
	
		
		$mail->From = 'labonicsejnu@gmail.com';
        $mail->Sender = $email;
...
if (isset($_POST['submit'])) {
	...
	if (!preg_match("/^b[0-9]+@[a-zA-Z]+.jnu.ac.bd+$/i", $email)) {
			...
			<div class="row justify-content-sm-center h-100">
				<div class="col-xxl-5 col-xl-6 col-lg-6 col-md-7 col-sm-9">
					<div class="text-center my-3">
						...
						<h1 class="fs-4 card-title fw-bold mb-4">Club Connect</h1>
					</div>
					<div class="card shadow-lg mb-1">
						<div class="card-body px-5 pt-4 pt-3">
							...
							<form action="" method="post" class="form" name="form" autocomplete="on">
								...
								<div class="mb-3">
									<label class="mb-2 text-muted" for="email">Gmail Address (JNU)</label>
								...
								<div class="dept mb-2">
									...
									<select name="dept_name" class="mb-3" id="type-option">
										...
										<option value="Microbiology">Microbiologo</option>
										<option value="Zoolog">Zoology</option>
					...
					<div class="text-center my-3 text-muted">
						<small>Copyright &copy; 2022-2023 &mdash; Team infinity</small>
					</div>
				</div>
			</div>
		</div>
